class LutarymSlideshowCard extends HTMLElement {
    ...
    root.innerHTML = `
      ...
      <div class="card">
        ...
        <div class="image-container" id="imageContainer">
          <div class="no-images">Bilder werden geladen</div>
        </div>
  ...
  async loadImages() {
    ...
    try {
      const path = `//${this.smbHost}/${this.smbShare}${this.imagePath}`;
      const today = new Date();
      today.setHours(0, 0, 0, 0);

      // Beispiel: statische Bilder laden (würde über SMB kommen)
      // In der echten Version würde eine HA-Automation die Bildliste bereitstellen
...
window.customCards.push({
  ...
  description: "Slideshow Card mit Bildverwaltung"
});
